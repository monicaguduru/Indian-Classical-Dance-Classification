...
def get_generators():
    ...
    validation_generator = test_datagen.flow_from_directory(  #Takes the path to a directory & generates batches of augmented data.
...
# imagenet is changed to activitynet
